return {
  ...
  keys = {
    ...
    { "<leader>/",          function() require("fzf-lua").live_grep({ resume = true }) end, desc = "Live grep (resume)" },
    { "<leader><leader>/",  function() require("fzf-lua").grep_curbuf() end,           desc = "Grep in current buffer" },
